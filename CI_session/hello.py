...
<body>
  <div class="content">
	<div class="title">Welcome to CI Session!</div>
	<div class="subtitle">Let's learn what is continuous integration!!.</div>
  </div>
</body>
</html>
'''
...
if __name__ == "__main__":
    pancakes.run(host="0.0.0.0", port=5000, debug=True)